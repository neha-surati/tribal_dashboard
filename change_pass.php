        ...
        <div class="mb-5">
            <form class="space-y-5" method="post">
                <div>
                    ...
                    <input id="oldPass" name="oldPass" placeholder="Enter Old Password" type="password" class="form-input" value="<?php echo (isset($mode)) ? $data['name'] : '' ?>" required <?php echo isset($mode) && $mode == 'view' ? 'readonly' : '' ?> />
                </div>
                <div>
                    <label for="newPass">New Password</label>
                    <input id="newPass" name="newPass" placeholder="Enter New Password" type="password" min="0" class="form-input" value="<?php echo (isset($mode)) ? $data['link'] : '' ?>" required <?php echo isset($mode) && $mode == 'view' ? 'readonly' : '' ?> />
                </div>
                <div>
                    <label for="confNewPass">Confirm New Password</label>
                    <input id="confNewPass" name="confNewPass" placeholder="Enter New Password Again" type="password" min="0" class="form-input" value="<?php echo (isset($mode)) ? $data['link'] : '' ?>" required <?php echo isset($mode) && $mode == 'view' ? 'readonly' : '' ?> />
                </div>
